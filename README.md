...
[![Go Report Card](https://goreportcard.com/badge/github.com/starlightromero/makesite)](https://goreportcard.com/report/github.com/YOUR_USERNAME/YOUR_REPONAME)
...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [x] **_FILL IN THE BLANK_**: `I will use the github.com/fatih/color library. The documentation is located at https://github.com/fatih/color. My goal is to use it to color terminal output.`
- [x] **Add, commit, and push to GitHub**.
